...
//        System.out.println(s);//[Nuriye, Orhan, Bunyamin, Saadet, Niyazi, Bilal, Abdullah]
        ...
        Returns:the head of this list, or null if this list is empty
         */
        String r2 = s.poll();//ilk node u size verir ve listeden siler (cut+ paste)
        ...
        /*
         ...
         Ama peek() list bos oldugunda size null verir. element() şse hata verir
         */
        ...
        /*
    poll() ile pop() methodlari ikisi de ilk elementi siler ve size verir.
