...
public class StringManipulations01 {
    public static void main(String[] args) {
        ...
        //Ornek 2: "t" Stringindeki tum rakamları ve harfleri "!" e ceviriniz
        ...
        //Ornek 4: "t" stringindeki kucuk harfler dısındaki tum characterleri "<>" ceviriniz
        String t4 = t.replaceAll("[^a-z]","<>");
        System.out.println(t4);//<>li<><><><>yasindadir<><><><>

        //Ornek 5: "t" Stringindeki tum harfler dısındaki tum chararcterleri "+" ceviriniz
        String t5 = t.replaceAll("[^a-zA-Z]","+");
        System.out.println(t5);//Ali++++yasindadir++++

        //Ornek 6: "t" stringindeki space ler dısındaki tum characterleri "?" ceviriniz
