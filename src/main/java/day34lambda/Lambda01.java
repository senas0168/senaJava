...
public class Lambda01 {
    public static void main(String[] args) {
        ...
        /*
        1)Lambda "Functional Programming" dir, digeri "Structured Pogramming" dir
        2)Functional Programming de "Ne yapılacak" (what to do) uzerine yogunlasılır
        "Structured Pogramming" "Nasıl yapılacak" (how to do) uzerine yogunlasılır
         3)Functional Programming java 8 ile kullanılmaya baslandı
         4)Functional Programming Collectionlar, ve Arraylerde kullanılır
         */
    ...
    //r) Bir list'teki cift elemanlari ayni satirda aralarina bosluk
