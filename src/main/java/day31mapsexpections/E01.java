...
public class E01 {
    ...
    ///ArithmeticException yazdiğiniz code da matematiksel işlem kullanıyorsanız alınabilecek bir exception dır.

    public static void divide2(int a,int b){
        try {
            System.out.println("try block ici exception oncesi");
            System.out.println(a/b);
            System.out.println("try block ici exception sonrası");
