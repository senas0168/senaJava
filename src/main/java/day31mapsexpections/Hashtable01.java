...
public class Hashtable01 {
  ...
  /*
    HashMap ile Hashtable arasindaki fark nedir?
        1) HashMap thread-safe(multy thread / çoklu iş yapabilme aynı anda) ve synchronized(işleri mantıklı sırayla  yapmak) degildir, Hastable thread-safe ve synchronized dir.
