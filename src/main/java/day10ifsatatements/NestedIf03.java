...
public class NestedIf03 {
    public static void main(String[] args) {
        ...
        if (firstChar>='A' && firstChar<='Z'){//Password'un ilk harfi buyuk ise
            if (firstChar=='A'){
            ...
            System.out.println("Ilk karakter harf olamalıdır");
        }

        //Note: Eger bir methodu tekrar tekra kullanmak istiyorsanız onu bir variable a atayarak kullanmak daha makuldur
    }
}
