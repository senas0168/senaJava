...
public class StringManipulation02 {
    public static void main(String[] args) {
        //Ornek 1: Bir string in belirli bir karakterinden baslayarak belirli bir karaktere kadar dynamic olarak alini
        //     abc@gmail.com  ====> gmail
        ...
        //Ornek 2: Verilen iki string in birbirinin aynısı olup olmadıgını kontrol eden kodu yazınız
        String h = "Ali Can";
        String i = "ali Can";
        ...
        System.out.println(s.equals(r));//true cunku equals() sadece degerlere bakar. "s" ve "r" nin degerleri aynı oldugunda

        //------------------------------------------------------------------------------------------------------------------//

        //Ornek 3: Verilen iki String in birbirinin aynısı olup olmadıgını buyuk harf kucuk harf dikkate almadan
        //kontrol eden kodu yazınız
        //equalsIgnoreCase() iki string in birbirinin aynısı olup olmadıgını buyuk harf kucuk harf dikkate almadan kontrol eder
