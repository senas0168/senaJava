...
public class Concatination {
    public static void main(String[] args) {
        ...
        //Ornek 1: Bir String ve iki integar variable olusturun. String degeri ile Integar şarın toplamını console a yazdırın
        String s = "elma";
        int a = 10;
        int b = 11;
        ...
        //Ornek 3: Size String olarak verilen iki fiyat'ın toplamını ekrana yazdırınız
        String tv = "$1100";
        String radio = "$300";
